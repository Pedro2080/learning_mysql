...
-- 1. Creating a report out of the orders table, get all the orders and next to each order add a label. If the order was placed in the current year the label will be "Active", otherwise the label is "Archived"
-- a) Active
USE store;
